...
Route::middleware('auth.basic')->group(function () {
    ...
    Route::post('reservation_insert_try/{book_id}', [LendingController::class, 'reservationInsertTry']);
    Route::post('kolcsonzes_Try/{copy_id}', [LendingController::class, 'kolcsonzesTry']);
    Route::post('kolcsonzes_Try_eves/{copy_id}', [LendingController::class, 'kolcsonzesTryEvenBelul']);
